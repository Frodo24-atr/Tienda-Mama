    ...
    <footer className="bg-stone-900 text-stone-400 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <p className="text-white font-bold tracking-[0.15em] uppercase text-lg mb-1">Solano & Co.</p>
            <p className="text-xs tracking-widest text-amber-600 uppercase mb-4">Indumentaria</p>
            <p className="text-sm leading-relaxed">
              Prendas seleccionadas con estilo. Nuevas y usadas en perfecto estado,
              con el sello de calidad de siempre.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/5491100000000" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors">
                  WhatsApp
                </a>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-600 text-base">📸</span>
                <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors">
                  Instagram
                </a>
              </li>
            </ul>
            <p className="mt-6 text-xs text-stone-600">
              Solano, Buenos Aires, Argentina
            </p>
          </div>
        </div>
